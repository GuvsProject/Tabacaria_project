...
const Sobre = () => (
  <Layout title="Sobre Nós">
    ...
    <div>
      ...
      <p>
      A Mario’s Tabacaria foi fundada em Santos – Litoral Paulista na década de 80 por Mario Mendes após o falecimento do senhor Mario, seu filho Helton seguiu com o negócio da família. É uma tabacaria já conhecida no centro de Santos e que tem sua história junto das antigas construções do centro da cidade.
